...
function CounterDemo(): JSX.Element {
  ...
  return (
    <>
      ...
      <button onClick={() => queueRerenderWithNewCounterValue(previousValue => previousValue - 5)}>-5</button>
      <button onClick={() => queueRerenderWithNewCounterValue(previousValue => previousValue - 1)}>-1</button>
      <button onClick={() => queueRerenderWithNewCounterValue(previousValue => previousValue + 5)}>+5</button>
      <hr />
